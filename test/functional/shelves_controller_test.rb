...
class ShelvesControllerTest < ActionController::TestCase
  ...
  test "should create shelf" do
    assert_difference('Shelf.count') do
      post :create, shelf: { currency: @shelf.currency, description: @shelf.description, language: @shelf.language, name: @shelf.name }
    end
  ...
  test "should update shelf" do
    put :update, id: @shelf, shelf: { currency: @shelf.currency, description: @shelf.description, language: @shelf.language, name: @shelf.name }
    assert_redirected_to shelf_path(assigns(:shelf))
  end
